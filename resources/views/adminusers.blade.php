...
<div class="group">
  <div class="overlap-10">
    ...
    <a href="{{route('render-adminusers')}}">
      <div class="text-wrapper-17">Пользователи</div>
    </a>
    <div class="text-wrapper-21">/</div>
    ...
    <div class="text-wrapper-18">Кол-во пользователей: {{$count}} шт.</div>
  </div>
  <div class="overlap-4">
    ...
    <table border="3" id="myTable">
      <tr>
        <div class="div15">
          ...
          <div class="text-wrapper668 sortable" id="email"><span>Почта</span>
            <img src="{{asset('storage/img/arrow.svg')}}" width="25px" class="arrowsort-none">
          </div>
          <div class="text-wrapper669 sortable" id="email_verified_at"><span>Подтверждение почты</span>
            <img src="{{asset('storage/img/arrow.svg')}}" width="25px" class="arrowsort-none">
          </div>
          <div class="text-wrapper668 sortable" id="password"><span>Пароль</span>
            <img src="{{asset('storage/img/arrow.svg')}}" width="25px" class="arrowsort-none">
          </div>
          <div class="text-wrapper668 sortable" id="created_at"><span>Дата создания</span>
            <img src="{{asset('storage/img/arrow.svg')}}" width="25px" class="arrowsort-none">
          </div>
          <div class="text-wrapper668 sortable" id="updated_at"><span>Дата обновления</span>
            <img src="{{asset('storage/img/arrow.svg')}}" width="25px" class="arrowsort-none">
          </div>
          <div class="text-wrapper670">Действия
          </div>
        </div>
      </tr>
...
@vite(['resources/js/app.js','resources/js/sortableuse.js', 'resources/js/bootstrap.js',
