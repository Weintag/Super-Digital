@if (Auth::user()->admin)
    ...
    <div class="group">
        <div class="overlap-10">
            ...
            <a href="{{route('render-admin')}}">
              ...
              <a href="{{route('render-adminorders')}}">
                <div class="text-wrapper-17">Заказы</div>
              </a>
        ...
        <div class="overlap-4">
            ...
            <div class="overlap-9">
                <div class="search_box">
                    <input class="search2" placeholder="Поиск..." name="search" type="search" id="searchInput"
                        autocomplete="off">
                    <div class="ic-baseline-search">
                        <button class="sear" onclick="searchTable()"><img
                                src="{{ asset('storage/img/ic-baseline-search.svg') }}"></button>
                    </div>
                </div>
            </div>
        ...
        <div class="rectangle">
            <table border="3" id="myTable">
                <tr>
                    <div class="div15">
                        <div class="text-wrapper666"><span>№</span>
                        </div>
                        <div class="text-wrapper668"><span>Номер заказа</span>
                        </div>
                        <div class="text-wrapper665"><span>Имя товара</span>
                        </div>
                        <div class="text-wrapper667"><span>Количество товара</span>
                        </div>
                        <div class="text-wrapper669"><span>Цена</span>
                        </div>
                        <div class="text-wrapper671"><span>Дата оформления</span>
                        </div>
                        <div class="text-wrapper672">Действия
                        </div>
                    </div>
                </tr>
                    ...
                    <tr>
                        ...
                        <div class="main-containerad">
                            ...
                            <div class="descriptionad">
                                ...
                                <th width="5%">
                                    <div class="orline">
                                        <form action="{{route('deleteordersprod', $orderproduct->id)}}" method="post">
                                            @csrf
    ...
    @vite(['resources/js/app.js', 'resources/js/sortableord.js', 'resources/js/bootstrap.js', 'resources/js/cart.js'])
    <script>
