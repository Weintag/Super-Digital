...
.main-cont125 {
  ...
  <div class="div-125">
    ...
    <div class="div-127">
      ...
      <div class="div-129">
        <input class="positive" type="radio"  name="type" value="Положительный" checked><img loading="lazy" src="{{asset('storage/img/bxs_smile.svg')}}" class="img125" />
        <input class="negative" type="radio" name="type" value="Отрицательный"><img loading="lazy" src="{{asset('storage/img/ph_smiley-sad-fill.svg')}}" class="img126" />
      </div>
      </div>
    </div>
  ...
  <div class="group">
    <div class="overlap-10">
      <div class="rev125">
        <a href="{{route('render-review')}}"><img  src="{{asset('storage/img/bxs_smile.svg')}}" class="img125" /></a>
