          ...
          <div class="main-container2">
            <div class="dron">
              <button onclick="myDron()" class="dron" id="dron">
                <div class="image-wrapper1">
                  <img id="showLayers" loading="lazy" srcset="{{asset('storage/img/ri_arrow-drop-down-line.svg')}}" class="img1" />
            ...
            <div class="dron">
              <button onclick="myDrona()" class="dron" id="dron1">
                <div class="image-wrapper1">
                  <img id="showLayers1" loading="lazy" srcset="{{asset('storage/img/ri_arrow-drop-down-line.svg')}}" class="img1" />
                  <div class="description">Жанры</div>
                </div>
              </button>
              <div id="myDrona" class="dron-content">
                <a href="{{route('sort', ['sort' => 'Экшн'])}}">
                  <p>Экшн</p>
                </a>
                <a href="{{route('sort', ['sort' => 'Приключения'])}}">
                  <p>Приключения</p>
                </a>
                <a href="{{route('sort', ['sort' => 'Ролевые'])}}">
                  <p>Ролевые (RPG)</p>
                </a>
                <a href="{{route('sort', ['sort' => 'Стратегии'])}}">
                  <p>Стратегии</p>
                </a>
                <a href="{{route('sort', ['sort' => 'Казуальные'])}}">
                  <p>Казуальные</p>
                </a>
                <a href="{{route('sort', ['sort' => 'Спорт'])}}">
                  <p>Спорт</p>
                </a>
                <a href="{{route('sort', ['sort' => 'Гонки'])}}">
                  <p>Гонки</p>
                </a>
                <a href="{{route('sort', ['sort' => 'Симуляторы'])}}">
                  <p>Симуляторы</p>
                </a>
              </div>
            </div>
            <div class="dron">
              <button onclick="myDrona1()" class="dron" id="dron2">
                <div class="image-wrapper1">
                  <img id="showLayers2" loading="lazy" srcset="{{asset('storage/img/ri_arrow-drop-down-line.svg')}}" class="img1" />
          ...
          <div class="obj2">
            ...
            <div class="framecart" id="myTable">
              <div class="overlap-group1">
                ...
                <div class="line"><img class="cat" src="{{asset('storage/img/mdi_steam.svg')}}">
                  @elseif($catalog->category == 'xbox')
                  <div class="line"><img class="cat" src="{{asset('storage/img/ri_xbox-fill11.svg')}}">
                    @elseif($catalog->category == 'playstation')
                    <div class="line"><img class="cat" src="{{asset('storage/img/ri_playstation-fill11.svg')}}">
                      @elseif($catalog->category == 'epicgames')
                      <div class="line"><img class="cat" src="{{asset('storage/img/simple-icons_epicgames.svg')}}">
