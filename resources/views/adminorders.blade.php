@if (Auth::user()->admin)
    ...
    <div class="group">
        <div class="overlap-10">
            ...
            <div class="text-wrapper-18">Кол-во заказов:
                {{$count}} шт.
            </div>
        </div>
        <div class="overlap-4">
            ...
            <table border="3" id="myTable">
                <tr>
                    <div class="div15">
                        ...
                        <div class="text-wrapper668 sortable" id="user_id"><span>Имя пользователя</span>
                            <img src="{{ asset('storage/img/arrow.svg') }}" width="25px" class="arrowsort-none">
                        </div>
                        <div class="text-wrapper665 sortable" id="pay"><span>Способ оплаты</span>
                            <img src="{{ asset('storage/img/arrow.svg') }}" width="25px" class="arrowsort-none">
                        </div>
                        <div class="text-wrapper667 sortable" id="email"><span>Почта</span>
                            <img src="{{ asset('storage/img/arrow.svg') }}" width="25px" class="arrowsort-none">
                        </div>
                        <div class="text-wrapper669"><span>Статус</span>
                        </div>
                        <div class="text-wrapper671 sortable" id="created_at"><span>Дата оформления</span>
                            <img src="{{ asset('storage/img/arrow.svg') }}" width="25px" class="arrowsort-none">
                        </div>
