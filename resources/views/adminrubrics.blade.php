  ...
  <div class="group">
    <div class="overlap-10">
      ...
      <a href="{{route('render-adminrubrics')}}">
        <div class="text-wrapper-17">Обратная связь</div>
      </a>
      <div class="text-wrapper-21">/</div>
      ...
      <div class="text-wrapper-18">Кол-во записей: {{$count}} шт.</div>
    </div>
    <div class="overlap-4">
    ...
    <div class="rectangle">
      <table border="3" id="myTable">
        <tr>
          <div class="div15">
            ...
            <div class="text-wrapper669 sortable" id="message"><span>Сообщение</span>
            <img src="{{asset('storage/img/arrow.svg')}}" width="25px" class="arrowsort-none">
            </div>
            <div class="text-wrapper667 sortable">Действия
            </div>
          </div>
        </tr>
     @foreach ($rubrics as $rubric)
      ...
      <div class="col-md-12">
      {{ $rubrics->onEachSide(2)->links('vendor.pagination.bootstrap-4') }}
    </div>
    </div>
    <div>
    <script>
...
$('#sh3').click(function() {
 ...
 <script>
  ...
  @vite(['resources/js/app.js','resources/js/sortablerub.js', 'resources/js/bootstrap.js',
