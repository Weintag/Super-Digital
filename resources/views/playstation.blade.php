...
<body>
    ...
    {{asset('storage/img/ri_arrow-drop-down-line.svg')}}
      " class="img1" />
              ...
              <div id="myDron" class="dron-content">
                <a href="{{ route('sort2', ['sort' => 'asc']) }}">
                  <p>По возрастанию</p>
                </a>
                <a href="{{ route('sort2', ['sort' => 'desc']) }}">
                  <p>По Убыванию</p>
                </a>
              </div>
            </div>
    ...
    {{asset('storage/img/ri_arrow-drop-down-line.svg')}}
      " class="img1" />
              ...
              <div id="myDrona" class="dron-content">
                <a href="{{route('sort2', ['sort' => 'Экшн'])}}">
                  <p>Экшн</p>
                </a>
                <a href="{{route('sort2', ['sort' => 'Приключения'])}}">
                  <p>Приключения</p>
                </a>
                <a href="{{route('sort2', ['sort' => 'Ролевые'])}}">
                  <p>Ролевые (RPG)</p>
                </a>
                <a href="{{route('sort2', ['sort' => 'Стратегии'])}}">
                  <p>Стратегии</p>
                </a>
                <a href="{{route('sort2', ['sort' => 'Казуальные'])}}">
                  <p>Казуальные</p>
                </a>
                <a href="{{route('sort2', ['sort' => 'Спорт'])}}">
                  <p>Спорт</p>
                </a>
                <a href="{{route('sort2', ['sort' => 'Гонки'])}}">
                  <p>Гонки</p>
                </a>
                <a href="{{route('sort2', ['sort' => 'Симуляторы'])}}">
                  <p>Симуляторы</p>
                </a>
              </div>
            </div>
    ...
    {{asset('storage/img/ri_arrow-drop-down-line.svg')}}
      " class="img1" />
              ...
              <div id="myDrona1" class="dron-content">
                <a href="{{ route('sort2', ['sort' => 'playstation4']) }}">
                  <p>Playstation 4</p>
                </a>
                <a href="{{ route('sort2', ['sort' => 'playstation5']) }}">
                  <p>Playstation 5</p>
                </a>
              </div>
            </div>
        ...
        <div class="obj1">
          <div class="obj2">
            ...
            @if($catalog->sale == '0' && $catalog->category == 'playstation')
            ...
            <div class="framecart" id="myTable">
              <div class="overlap-group1">
                ...
                @if($catalog->category == 'playstation')
  ...
  <div class="frame3">
    ...
    <div class="obj3">
      ...
      @if($catalog->sale == '1' && $catalog->category == 'playstation')
