...
<body>
    ...
    {{asset('storage/img/ri_arrow-drop-down-line.svg')}}
      " class="img1" />
              ...
              <div id="myDron" class="dron-content">
                <a href="{{ route('sort3', ['sort' => 'asc']) }}">
                  <p>По возрастанию</p>
                </a>
                <a href="{{ route('sort3', ['sort' => 'desc']) }}">
                  <p>По Убыванию</p>
                </a>
              </div>
            </div>
    ...
    {{asset('storage/img/ri_arrow-drop-down-line.svg')}}
      " class="img1" />
              ...
              <div id="myDrona" class="dron-content">
                <a href="{{route('sort3', ['sort' => 'Экшн'])}}">
                  <p>Экшн</p>
                </a>
                <a href="{{route('sort3', ['sort' => 'Приключения'])}}">
                  <p>Приключения</p>
                </a>
                <a href="{{route('sort3', ['sort' => 'Ролевые'])}}">
                  <p>Ролевые (RPG)</p>
                </a>
                <a href="{{route('sort3', ['sort' => 'Стратегии'])}}">
                  <p>Стратегии</p>
                </a>
                <a href="{{route('sort3', ['sort' => 'Казуальные'])}}">
                  <p>Казуальные</p>
                </a>
                <a href="{{route('sort3', ['sort' => 'Спорт'])}}">
                  <p>Спорт</p>
                </a>
                <a href="{{route('sort3', ['sort' => 'Гонки'])}}">
                  <p>Гонки</p>
                </a>
                <a href="{{route('sort3', ['sort' => 'Симуляторы'])}}">
                  <p>Симуляторы</p>
                </a>
              </div>
            </div>
    ...
    {{asset('storage/img/ri_arrow-drop-down-line.svg')}}
      " class="img1" />
              ...
              <div id="myDrona1" class="dron-content">
                <a href="{{ route('sort3', ['sort3' => 'xbox360']) }}">
                  <p>Xbox 360</p>
                </a>
                <a href="{{ route('sort3', ['sort3' => 'xboxone']) }}">
                  <p>Xbox One</p>
                </a>
                <a href="{{ route('sort3', ['sort3' => 'xboxseriess']) }}">
        ...
        <div class="obj1">
          <div class="obj2">
            ...
            @if($catalog->sale == '0' && $catalog->category == 'xbox')
  ...
  <div class="frame3">
    ...
    <div class="obj3">
      ...
      @if($catalog->sale == '1' && $catalog->category == 'xbox')
      ?>
