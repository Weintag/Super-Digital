...
<body>
    ...
    {{asset('storage/img/ri_arrow-drop-down-line.svg')}}
      " class="img1" />
              ...
              <div id="myDron" class="dron-content">
                <a href="{{ route('sort1', ['sort' => 'asc']) }}">
                  <p>По возрастанию</p>
                </a>
                <a href="{{ route('sort1', ['sort' => 'desc']) }}">
                  <p>По Убыванию</p>
                </a>
              </div>
            </div>
    ...
    {{asset('storage/img/ri_arrow-drop-down-line.svg')}}
      " class="img1" />
              ...
              <div id="myDrona" class="dron-content">
                <a href="{{route('sort1', ['sort' => 'Экшн'])}}">
                  <p>Экшн</p>
                </a>
                <a href="{{route('sort1', ['sort' => 'Приключения'])}}">
                  <p>Приключения</p>
                </a>
                <a href="{{route('sort1', ['sort' => 'Ролевые'])}}">
                  <p>Ролевые (RPG)</p>
                </a>
                <a href="{{route('sort1', ['sort' => 'Стратегии'])}}">
                  <p>Стратегии</p>
                </a>
                <a href="{{route('sort1', ['sort' => 'Казуальные'])}}">
                  <p>Казуальные</p>
                </a>
                <a href="{{route('sort1', ['sort' => 'Спорт'])}}">
                  <p>Спорт</p>
                </a>
                <a href="{{route('sort1', ['sort' => 'Гонки'])}}">
                  <p>Гонки</p>
                </a>
                <a href="{{route('sort1', ['sort' => 'Симуляторы'])}}">
                  <p>Симуляторы</p>
                </a>
              </div>
            </div>
      ...
      " class="img1" />
        ...
        <div class="obj1">
          <div class="obj2">
            ...
            @if($catalog->sale == '0' && $catalog->category == 'steam')
  ...
  <div class="frame3" >
    ...
    <div class="obj3" id="myDiv">
      ...
      @if($catalog->sale == '1' && $catalog->category == 'steam')
